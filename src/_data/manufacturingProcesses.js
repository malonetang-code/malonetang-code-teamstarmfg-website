module.exports = [
  {
    number: "01",
    slug: "material-verification",
    title: { zh: "材料确认", en: "Material Verification" },
    detail: {
      zh: "使用手持分析设备对材料进行相应核对，具体牌号与要求以技术文件和检验记录为准。",
  ...
  },
  {
    number: "02",
    slug: "blank-shaping",
    title: { zh: "刀坯成形", en: "Blank Shaping" },
    detail: {
      zh: "依据确认版图纸进行激光切割等刀坯成形，后续工序根据结构和材料安排。",
      en: "Laser cutting and other blank-shaping processes follow the approved drawing, with subsequent operations planned around geometry and material.",
    },
  ...
  },
  {
    number: "03",
    slug: "heat-treatment",
    title: { zh: "热处理", en: "Heat Treatment" },
    detail: {
      zh: "刀坯按经确认的工艺路线进入热处理，温度曲线与具体工艺参数不在网站公开。",
      en: "Blade blanks enter heat treatment under an approved process route. Temperature profiles and detailed process parameters are not published online.",
    },
  ...
  },
  {
    number: "04",
    slug: "machining",
    title: { zh: "机加工", en: "Machining" },
    detail: {
      zh: "依据安装接口和几何要求安排机加工，可实现范围和公差需结合图纸评估。",
      en: "Machining is planned around mounting interfaces and geometric requirements. Feasible ranges and tolerances require drawing review.",
    },
  ...
  },
  {
    ...
    title: { zh: "精密研磨", en: "Precision Grinding" },
    detail: {
      zh: "通过相应研磨工序形成刃口和关键表面，磨削方案按刀型和应用要求确认。",
      en: "Applicable grinding processes form the cutting edge and critical surfaces. The grinding route is confirmed for each blade geometry and application.",
    },
  ...
  },
  {
    ...
    title: { zh: "过程检验", en: "In-process Inspection" },
    detail: {
      zh: "加工过程中使用量具和检测设备核对相应特征，依据确认版图纸和过程要求执行。",
      en: "Gauges and inspection equipment are used to check applicable features during production against the approved drawing and process requirements.",
    },
  ...
  },
  {
    ...
    title: { zh: "最终检验", en: "Final Inspection" },
    detail: {
      zh: "成品依据确认版图纸和验收要求进行尺寸及相关项目检查，批次记录受控保存。",
      en: "Finished blades are checked against the approved drawing and acceptance requirements, while applicable batch records remain controlled.",
    },
  ...
  },
  {
    ...
    title: { zh: "包装防护", en: "Protective Packaging" },
    detail: {
      zh: "根据刀型和交付条件执行清洁、刃口防护与包装，标签与批次信息按项目要求管理。",
      en: "Cleaning, edge protection and packaging are selected for the blade and delivery conditions, with labels and batch information managed to project requirements.",
    },
